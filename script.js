...
function changeBall(colorToChange, addedClass, buttonColorCode, speed){         //Function for changing the ball color
  ...
  var coloredFavicon = "/images/" + colorToChange + ".png"


  favicon.setAttribute("href", "/images/blank.png");
  setTimeout(
    function(){
      favicon.setAttribute("href", coloredFavicon);
    }, 500
  )
...
//SECRET CODE SETUP ------------------------------------------------------------
      ...
      //Code: wgb         Event: Open WeGoBuy                               Chec
          if (typedString == 'wgb') {
            window.location = 'https://www.wegobuy.com/en/'
          }
